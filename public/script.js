...
<br>Очки каждого участника за Гран-при суммируются, и из этого выходят очки клана, что позволяет бороться с другими сообществами за призы и звание Чемпиона!</p>
        </div>
      </div>
